...
public final class Encoder {
    ...
    public static byte[] encode(String text) throws EncodingException {
        byte[] byteValue = getByteValue(text);
        return packBytes(byteValue);
    }

    private static byte[] getByteValue(String text) throws EncodingException {
    ...
    private static byte[] packBytes(byte[] unpackedBytes) {
